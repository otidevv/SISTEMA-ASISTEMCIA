...
class AsistenciaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        foreach ($registros as $registro) {
            $infoHabilitacion = \App\Helpers\AsistenciaHelper::obtenerEstadoHabilitacion($registro->nro_documento);
            
            $registro->total_asistencias = $infoHabilitacion['asistencias'];
            $registro->total_faltas = $infoHabilitacion['faltas'];
            $registro->estado_habilitacion = $infoHabilitacion['estado'];
            $registro->puede_rendir = $infoHabilitacion['puede_rendir'];
            $registro->examen_actual = $infoHabilitacion['examen'];
            $registro->limite_amonestacion = $infoHabilitacion['limite_amonestacion'];
            $registro->limite_inhabilitacion = $infoHabilitacion['limite_inhabilitacion'];
            $registro->dias_habiles_totales = $infoHabilitacion['dias_habiles_totales'];
        }
