...
<header class="main-header">
    <div class="header-content">
        ...
        <ul class="nav-menu" id="navMenu">
            ...
            <li><a href="{{ route('public.secundaria') }}"
                    class="{{ request()->routeIs('public.secundaria') ? 'active' : '' }}">Secundaria <span
                        class="badge-new">NEW</span></a></li>
            <li><a href="{{ route('public.cursos') }}"
                    class="{{ request()->routeIs('public.cursos') ? 'active' : '' }}">Cursos <span
                        class="badge-new">NEW</span></a></li>
            <li><a href="{{ route('public.carreras.index') }}"
                    class="{{ request()->routeIs('public.carreras.*') ? 'active' : '' }}">Carreras <span
                        class="badge-new">NEW</span></a></li>
