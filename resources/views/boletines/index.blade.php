...
@push('js')
    ...
    {{-- DataTables 1.13.7 (BS5) - Mantener si es necesario para esta vista específica, 
         pero notar que el layout usa BS4. Si hay errores de estilo, considerar revertir a BS4 --}}
