                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Crear Parentesco</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Crear Nuevo Parentesco</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="tipo_parentesco" name="tipo_parentesco" required>
                                            ...
                                            @foreach ($tiposParentesco as $tipo)
                                                <option value="{{ $tipo }}"
                                                    {{ old('tipo_parentesco') == $tipo ? 'selected' : '' }}>
                                                    {{ ucfirst($tipo) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input type="checkbox" class="form-check-input" id="recibe_notificaciones"
                                                ...
                                                {{ old('recibe_notificaciones', '1') == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input type="checkbox" class="form-check-input" id="contacto_emergencia"
                                                ...
                                                {{ old('contacto_emergencia', '0') == '1' ? 'checked' : '' }}>
