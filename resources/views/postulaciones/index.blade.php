...
@push('css')
    ...
    <link href="https://cdn.jsdelivr.net/npm/select2-bootstrap-5-theme@1.30/dist/select2-bootstrap-5-theme.min.css" rel="stylesheet" />
    <!-- Bootstrap Icons -->
...
@push('modals')
    ...
    <!-- Modal para Ver Detalle (Premium Design) -->
    <div class="modal fade" id="viewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xxl modal-dialog-centered">
            <div class="modal-content premium-modal" id="viewModalContent">
                <div id="viewModalBody">
                    <!-- Contenido inyectado dinámicamente por resources/js/postulaciones/index.js -->
                    <div class="p-5 text-center">
                        <div class="spinner-border text-primary" role="status"></div>
                        <p class="mt-2 text-muted">Cargando información premium...</p>
                    </div>
                </div>
            </div>
        </div>
